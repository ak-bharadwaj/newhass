...
export default function ReceptionDashboard() {
  ...
  if (isLoading) {
    return (
      <div className={`min-h-screen p-8 ${isDark ? 'bg-gradient-to-br from-gray-900 via-blue-900/20 to-cyan-900/20' : 'bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50'}`}>
        <DashboardSkeleton />
      </div>
    )
  }
        ...
        <div className="container mx-auto px-2">
          <div className="flex items-center gap-3 flex-wrap">
            <FeedbackButton
              ...
              variant="secondary"
              className="shadow-xl bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white px-6 py-3 rounded-xl font-semibold flex items-center gap-2"
            >
